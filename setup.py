...
class build(_build):
    ...
    def build_v8(self):
        ...
        proc = subprocess.Popen(cmdline, cwd=V8_HOME, shell=True, 0")

		proc = subprocess.Popen(["scons"        proc.communicate()

        stdout=sys.stdout, stderr            print "WARN: fail to build Google v8 code from SVN, error code: ", proc.returncode
